...
var setData = toolkit.createAction("SET_DATA", function (data) { return ({ payload: { data: data } }); });
var selectEntireRow = toolkit.createAction("SELECT_ENTIRE_ROW", function (row, extend) { return ({ payload: { row: row, extend: extend } }); });
var selectEntireColumn = toolkit.createAction("SELECT_ENTIRE_COLUMN", function (column, extend) {
    return ({
        payload: { column: column, extend: extend },
    });
});
var selectEntireTable = toolkit.createAction("SELECT_ENTIRE_TABLE");
var select = toolkit.createAction("SELECT", function (point) { return ({ payload: { point: point } }); });
var activate = toolkit.createAction("ACTIVATE", function (point) { return ({ payload: { point: point } }); });
var setCellData = toolkit.createAction("SET_CELL_DATA", function (active, data, getBindingsForCell) {
    return ({
        payload: { active: active, data: data, getBindingsForCell: getBindingsForCell },
    });
});
var setCellDimensions = toolkit.createAction("SET_CELL_DIMENSIONS", function (point, dimensions) {
    return ({
        payload: { point: point, dimensions: dimensions },
    });
});
var copy = toolkit.createAction("COPY");
var cut = toolkit.createAction("CUT");
var paste = toolkit.createAction("PASTE", function (data) { return ({ payload: { data: data } }); });
var edit$1 = toolkit.createAction("EDIT");
var view$1 = toolkit.createAction("VIEW");
var clear$1 = toolkit.createAction("CLEAR");
var blur$1 = toolkit.createAction("BLUR");
var keyPress = toolkit.createAction("KEY_PRESS", function (event) { return ({ payload: { event: event } }); });
var keyDown = toolkit.createAction("KEY_DOWN", function (event) { return ({ payload: { event: event } }); });
var dragStart = toolkit.createAction("DRAG_START");
var dragEnd = toolkit.createAction("DRAG_END");
var commit$1 = toolkit.createAction("COMMIT", function (changes) { return ({ payload: { changes: changes } }); });
...
var Table = function (_a) {
    ...
    var columnNodes = range(columnCount).map(function (i) { return React__namespace.createElement("col", { key: i }); });
    return (React__namespace.createElement("table", { className: "Spreadsheet__table" },
        React__namespace.createElement("colgroup", null, columnNodes),
        React__namespace.createElement("tbody", null, children)));
};

var Row = function (props) { return React__namespace.createElement("tr", __assign({}, props)); };

var HeaderRow = function (props) { return React__namespace.createElement("tr", __assign({}, props)); };
...
var reducer = toolkit.createReducer(INITIAL_STATE, function (builder) {
    ...
    builder.addCase(paste, function (state, action) {
        ...
        return __assign(__assign({}, state), {
            data: data, selected: create(active, {
...
var context = useContextSelector.createContext([INITIAL_STATE, function () { }]);

function useDispatch() {
    return useContextSelector.useContextSelector(context, function (_a) {
...
var CornerIndicator = function (_a) {
    ...
    var handleClick = React__namespace.useCallback(function () {
        onSelect();
    }, [onSelect]);
    return (React__namespace.createElement("th", {
        className: classNames__default['default']("Spreadsheet__header", {
...
var enhance$3 = function (CornerIndicatorComponent) {
    return function CornerIndicatorWrapper(props) {
        ...
        var selectEntireTable$1 = React__namespace.useCallback(function () { return dispatch(selectEntireTable()); }, [dispatch]);
        var selected = useSelector(function (state) {
            return isEntireTable(state.selected);
        });
        return (React__namespace.createElement(CornerIndicatorComponent, __assign({}, props, { selected: selected, onSelect: selectEntireTable$1 })));
    };
};
...
var ColumnIndicator = function (_a) {
    ...
    }, label !== undefined ? label : hotFormulaParser.columnIndexToLabel(String(column))));
};
var enhance$2 = function (ColumnIndicatorComponent) {
    return function ColumnIndicatorWrapper(props) {
        var dispatch = useDispatch();
        var selectEntireColumn$1 = React__namespace.useCallback(function (column, extend) {
        ...
        return (React__namespace.createElement(ColumnIndicatorComponent, __assign({}, props, { selected: selected, onSelect: selectEntireColumn$1 })));
    };
};
...
var enhance$1 = function (RowIndicatorComponent) {
    return function RowIndicatorWrapper(props) {
        ...
        var selectEntireRow$1 = React__namespace.useCallback(function (row, extend) {
            return dispatch(selectEntireRow(row, extend));
        }, [dispatch]);
        return (React__namespace.createElement(RowIndicatorComponent, __assign({}, props, { selected: selected, onSelect: selectEntireRow$1 })));
    };
};
...
var Cell = function (_a) {
    ...
    var point = React__namespace.useMemo(function () {
        return ({
            row: row,
            column: column,
        });
    ...
    return (React__namespace.createElement("td", {
        ref: rootRef, className: classNames__default['default']("Spreadsheet__cell", data === null || data === void 0 ? void 0 : data.className, {
        ...
        React__namespace.createElement(DataViewer, { row: row, column: column, cell: data, formulaParser: formulaParser, setCellData: setCellData })));
};
var enhance = function (CellComponent) {
    return function CellWrapper(props) {
        var row = props.row, column = props.column;
        var dispatch = useDispatch();
        var setCellData$1 = React__namespace.useCallback(function (data) {
        ...
        var select$1 = React__namespace.useCallback(function (point) { return dispatch(select(point)); }, [dispatch]);
        var activate$1 = React__namespace.useCallback(function (point) { return dispatch(activate(point)); }, [dispatch]);
        var setCellDimensions$1 = React__namespace.useCallback(function (point, dimensions) {
        ...
        return (React__namespace.createElement(CellComponent, __assign({}, props, { selected: selected, active: active, copied: copied, dragging: dragging, mode: mode, data: data, select: select$1, activate: activate$1, setCellDimensions: setCellDimensions$1, setCellData: setCellData$1 })));
    };
};
...
var DataEditor = function (_a) {
    ...
    return (
        React__namespace.createElement("div", { className: "Spreadsheet__data-editor" },
...
var ActiveCell = function (props) {
    ...
    var dispatch = useDispatch();
    var setCellData$1 = React__namespace.useCallback(function (active, data) {
        return dispatch(setCellData(active, data, getBindingsForCell));
    }, [dispatch, getBindingsForCell]);
    var edit = React__namespace.useCallback(function () { return dispatch(edit$1()); }, [dispatch]);
    var commit = React__namespace.useCallback(function (changes) {
        return dispatch(commit$1(changes));
    }, [dispatch]);
    var view = React__namespace.useCallback(function () {
        dispatch(view$1());
    }, [dispatch]);
    ...
    var hidden = React__namespace.useMemo(function () { return !active || !dimensions; }, [active, dimensions]);
    var initialCellRef = React__namespace.useRef(undefined);
    var prevActiveRef = React__namespace.useRef(null);
    var prevCellRef = React__namespace.useRef(undefined);
    var handleChange = React__namespace.useCallback(function (cell) {
        if (!active) {
            return;
        }
    ...
    return hidden ? null : (React__namespace.createElement("div", { ref: rootRef, className: classNames__default['default']("Spreadsheet__active-cell", "Spreadsheet__active-cell--" + mode), style: dimensions, onClick: mode === "view" && !readOnly ? edit : undefined, tabIndex: 0 }, mode === "edit" && active && (React__namespace.createElement(DataEditor, {
        row: active.row, column: active.column, cell: cell,
        // @ts-ignore
...
var FloatingRect = function (_a) {
    ...
    return (React__namespace.createElement("div", {
        className: classNames__default['default']("Spreadsheet__floating-rect", (_b = {},
...
var Selected = function () {
    ...
    return (React__namespace.createElement(FloatingRect, { variant: "selected", dimensions: dimensions, dragging: dragging, hidden: hidden }));
};
...
var Copied = function () {
    ...
    return (React__namespace.createElement(FloatingRect, { variant: "copied", dimensions: dimensions, hidden: hidden, dragging: false }));
};
...
var Spreadsheet = function (props) {
    ...
    var initialState = React__namespace.useMemo(function () {
        return (__assign(__assign({}, INITIAL_STATE), { data: props.data }));
    }, [props.data]);
    var reducerElements = React__namespace.useReducer(reducer, initialState);
    var _o = __read(reducerElements, 2), state = _o[0], dispatch = _o[1];
    var size = React__namespace.useMemo(function () {
        return calculateSpreadsheetSize(state.data, rowLabels, columnLabels);
    }, [state.data, rowLabels, columnLabels]);
    var mode = state.mode;
    var rootRef = React__namespace.useRef(null);
    var prevStateRef = React__namespace.useRef(__assign(__assign({}, INITIAL_STATE), { data: props.data, selected: null, copied: from$1([]), bindings: from$1([]), lastCommit: null }));
    var copy$1 = React__namespace.useCallback(function () { return dispatch(copy()); }, [dispatch]);
    var cut$1 = React__namespace.useCallback(function () { return dispatch(cut()); }, [dispatch]);
    var paste$1 = React__namespace.useCallback(function (data) { return dispatch(paste(data)); }, [dispatch]);
    var onKeyDownAction = React__namespace.useCallback(function (event) { return dispatch(keyDown(event)); }, [dispatch]);
    var onKeyPress = React__namespace.useCallback(function (event) { return dispatch(keyPress(event)); }, [dispatch]);
    var onDragStart = React__namespace.useCallback(function () { return dispatch(dragStart()); }, [dispatch]);
    var onDragEnd = React__namespace.useCallback(function () { return dispatch(dragEnd()); }, [dispatch]);
    var setData$1 = React__namespace.useCallback(function (data) { return dispatch(setData(data)); }, [dispatch]);
    var blur = React__namespace.useCallback(function () { return dispatch(blur$1()); }, [dispatch]);
    React__namespace.useEffect(function () {
        var e_1, _a;
    ...
    var clip = React__namespace.useCallback(function (event) {
    ...
    var handleCut = React__namespace.useCallback(function (event) {
    ...
    var handleCopy = React__namespace.useCallback(function (event) {
        if (shouldHandleClipboardEvent(rootRef.current, mode)) {
            event.preventDefault();
            event.stopPropagation();
            clip(event);
    ...
    var handlePaste = React__namespace.useCallback(function (event) {
        if (shouldHandleClipboardEvent(rootRef.current, mode)) {
            event.preventDefault();
            event.stopPropagation();
    ...
    var handleMouseUp = React__namespace.useCallback(function () {
        onDragEnd();
    ...
    var handleBlur = React__namespace.useCallback(function (event) {
        /**
    ...
    var formulaParser = React__namespace.useMemo(function () {
        return props.formulaParser || new hotFormulaParser.Parser();
    }, [props.formulaParser]);
    var Cell$1 = React__namespace.useMemo(function () {
        // @ts-ignore
        return enhance(props.Cell || Cell);
    }, [props.Cell]);
    var CornerIndicator$1 = React__namespace.useMemo(function () {
        return enhance$3(props.CornerIndicator || CornerIndicator);
    }, [props.CornerIndicator]);
    var RowIndicator$1 = React__namespace.useMemo(function () { return enhance$1(props.RowIndicator || RowIndicator); }, [props.RowIndicator]);
    var ColumnIndicator$1 = React__namespace.useMemo(function () {
    ...
    var tableNode = React__namespace.useMemo(function () {
        return (React__namespace.createElement(Table$1, { columns: size.columns, hideColumnIndicators: hideColumnIndicators },
            React__namespace.createElement(HeaderRow$1, null,
                !hideRowIndicators && !hideColumnIndicators && React__namespace.createElement(CornerIndicator$1, null),
                !hideColumnIndicators &&
                range(size.columns).map(function (columnNumber) {
                    return columnLabels ? (React__namespace.createElement(ColumnIndicator$1, {
                        key: columnNumber, column: columnNumber, label: columnNumber in columnLabels
                            ? columnLabels[columnNumber]
                            : null
                    })) : (React__namespace.createElement(ColumnIndicator$1, { key: columnNumber, column: columnNumber }));
                })),
            range(size.rows).map(function (rowNumber) {
                return (React__namespace.createElement(Row$1, { key: rowNumber, row: rowNumber },
                    !hideRowIndicators &&
                    (rowLabels ? (React__namespace.createElement(RowIndicator$1, { key: rowNumber, row: rowNumber, label: rowNumber in rowLabels ? rowLabels[rowNumber] : null })) : (React__namespace.createElement(RowIndicator$1, { key: rowNumber, row: rowNumber }))),
                    range(size.columns).map(function (columnNumber) {
                        return (React__namespace.createElement(Cell$1, {
                            key: columnNumber, row: rowNumber, column: columnNumber,
                            // @ts-ignore
    ...
    var activeCellNode = React__namespace.useMemo(function () {
        return (React__namespace.createElement(ActiveCell
            // @ts-ignore
            , {
                // @ts-ignore
    ...
    var rootNode = React__namespace.useMemo(function () {
        return (React__namespace.createElement("div", {
            ref: rootRef, className: classNames__default['default']("Spreadsheet", className, {
            ...
            tableNode,
            activeCellNode,
            React__namespace.createElement(Selected, null),
            React__namespace.createElement(Copied, null)));
    }, [
        className,
        darkMode,
        onKeyPress,
